...
export class News extends Component {
  ...
  updateNews = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apiKey=e31a769cac7a4d0196c1dc31dc08f147&page=${page}&pageSize=${pageSize}`;
  ...
  fetchMoreData = async () => {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${country}&category=${category}&apiKey=e31a769cac7a4d0196c1dc31dc08f147&page=${nextPage}&pageSize=${pageSize}`;
