...
const Recommendationslm = () => {
    ...
    const fetchRecommendations = async () => {
      ...
      try {
        const response = await fetch(
          `http://localhost:5000/api/recommendations-lm?email=${userEmail}`
        );
  ...
  return (
    <div className="container my-3">
      <h2 className="text-center">📝 Recommended Articles Using MiniLM-L6-v2</h2>
      {loading ? (
        <Spinner />
      ) : (
        <div className="row">
...
export default Recommendationslm;
